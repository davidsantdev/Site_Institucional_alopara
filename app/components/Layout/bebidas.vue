...
const produtoSelecionado = ref<any>(null)
  ...
  const bebidasLimitados = bebidas.slice(0, 5)


  function aumentar(id: number) {
  const item = bebidasLimitados.find(p => p.id === id)
                      ...
                      <div class="flex flex-col">
                        ...
                        <div class="flex justify-center gap-3 mt-6">
                          ...
                          <div class="flex gap-2">
                            ...
                            <button class="text-[#888] bg-[#1e1e1e] rounded-[10px] p-2 w-10 border"
                              @click="aumentar(B.id)">+</button>
                          </div>

                          <Button 
                            @click="adicionarCarrinho(B, B.quantidade)"
