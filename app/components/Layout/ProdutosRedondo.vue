...
const categorias = [
  {
    ...
    rota: '/Alimentos',
    img: alimentosImg,
    hover: 'hover:border-red-600/60 hover:bg-[#1a0d0d]',
  ...
  },
  {
    ...
    rota: '/Bebidas',
    img: bebidasImg,
    hover: 'hover:border-cyan-500/60 hover:bg-[#0d1a1f]',
  ...
  },
  {
    ...
    rota: '/Limpeza',
    img: limpezaImg,
    hover: 'hover:border-blue-500/60 hover:bg-[#0d151f]',
  ...
  },
  {
    ...
    rota: '/Perfumaria',
    img: perfumariaImg,
    hover: 'hover:border-pink-500/60 hover:bg-[#1f0d17]',
  ...
  <section class="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-12 md:py-14">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
      <div
        ...
        class="group relative overflow-hidden bg-[#161616] border border-[#1f1f1f] rounded-2xl p-4 sm:p-5 md:p-6 cursor-pointer
      ...
      >
        ...
        <div class="relative flex flex-col gap-1 md:gap-1.5">
          <h3 class="text-white text-[15px] md:text-[18px] font-extrabold tracking-tight transition-colors duration-200" :class="cat.texto">
            {{ cat.titulo }}
          </h3>
          <p class="text-[#555] text-[10px] md:text-[11px] font-semibold tracking-wide uppercase truncate">
            {{ cat.desc }}
          </p>
        </div>

        <!-- rodapé -->
        <div class="relative flex items-center justify-between pt-3 md:pt-4 border-t border-[#1f1f1f] mt-auto">
          <span class="text-[#333] text-[10px] md:text-[11px] font-bold tracking-[1.5px] uppercase transition-colors duration-200" :class="cat.texto">
            Ver todos
          </span>
          <div
            class="w-6 h-6 md:w-7 md:h-7 shrink-0 rounded-full border border-[#2a2a2a] flex items-center justify-center transition-all duration-200"
            :class="cat.aro"
          >
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"
              class="text-[#444] group-hover:text-white transition-colors duration-200">
