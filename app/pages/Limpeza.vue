...
import {
  Sparkles, Search, X, ChevronUp, ShoppingCart,
...
async function buscarProdutos(pagina = 1) {
  ...
  try {
    const res = await $fetch<any>('/api/limpeza', {
...
<template>
  <div class="min-h-screen bg-[#F2F3F5] flex flex-col font-sans">
    ...
    <!-- ===== HERO ===== -->
    <div class="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-400 px-4 py-10 text-white">
      <div
        ...
        <div class="mx-auto mt-7 max-w-2xl">
          <div class="relative">
            ...
            <input
              ...
              class="h-14 w-full rounded-2xl border-0 bg-white pl-14 pr-14 text-gray-800 shadow-xl outline-none ring-0 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-300 transition text-base"
            />
            <button
              v-if="busca"
              @click="busca = ''"
    ...
    <div v-if="erro" class="flex flex-1 items-center justify-center py-32">
      <div class="text-center">
        ...
        <button
          ...
          class="mt-6 rounded-xl bg-blue-500 px-6 py-3 text-white font-bold hover:bg-blue-600 transition"
        >
          Tentar novamente
        </button>
      </div>
      ...
      <div v-else class="mx-auto w-full max-w-7xl px-3 py-6 md:px-6">
        ...
        <div class="mb-4 flex items-center justify-between">
          <p class="text-sm text-gray-500 flex items-center gap-2">
            ...
            produtos
            <template v-if="busca"> para "<span class="text-blue-500">{{ busca }}</span>"</template>
            <span
              v-if="!cacheCompleto"
              class="inline-flex items-center gap-1 rounded-full bg-blue-100 px-2 py-0.5 text-[11px] text-blue-600 font-medium"
            >
        ...
        >
          ...
          >
            <div class="absolute left-2 top-2 z-10 flex items-center gap-1 rounded-full bg-blue-500 px-2 py-0.5 text-[10px] font-bold text-white shadow">
              <Sparkles :size="9" />
              Top
            </div>
            <button
            ...
            <div class="flex h-36 items-center justify-center bg-slate-50 p-3 group-hover:bg-blue-50 transition-colors duration-200">
              <img
        ...
        <div v-if="totalPaginas > 1" class="mt-10 flex flex-col items-center gap-3">
          ...
          <div v-if="!cacheCompleto" class="flex items-center gap-2 text-xs text-blue-500 mb-1">
          ...
          <div class="flex items-center gap-1">
            ...
            <button
              ...
              class="flex h-9 w-9 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-500 hover:bg-blue-50 hover:text-blue-500 hover:border-blue-200 disabled:opacity-30 disabled:cursor-not-allowed transition"
            >
              <ChevronLeft :size="16" />
            </button>
              ...
              <button
                ...
                :class="[
                  ...
                  p === paginaAtual
                    ...
                    : 'border border-gray-200 bg-white text-gray-600 hover:bg-blue-50 hover:text-blue-500 hover:border-blue-200'
                ]"
              >{{ p }}</button>
            </template>
          ...
          <div class="px-8 py-6">
            ...
            <div class="mt-6 flex items-center gap-3">
              ...
              <button
                ...
                class="flex flex-1 items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3 text-white font-bold text-base hover:bg-blue-700 active:scale-95 transition-all shadow-lg shadow-blue-900/30"
              >
    ...
    <Transition name="fade">
      <button
        v-if="mostrarTopo"
        @click="scrollTopo"
        class="fixed bottom-6 right-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-blue-500 text-white shadow-xl hover:bg-blue-600 active:scale-90 transition-all"
      >
        <ChevronUp :size="22" />
      </button>
    </Transition>
