  ...
  <div class="min-h-screen bg-[#F2F3F5] flex flex-col font-sans">
        ...
        <div class="mx-auto mt-7 max-w-2xl">
          <div class="relative">
            ...
            <input
              ...
              class="h-14 w-full rounded-2xl border-0 bg-white pl-14 pr-14 text-gray-800 shadow-xl outline-none ring-0 placeholder:text-gray-400 focus:ring-2 focus:ring-cyan-300 transition text-base"
            />
            <button
              v-if="busca"
              @click="busca = ''"
    ...
    <div v-if="erro" class="flex flex-1 items-center justify-center py-32">
      <div class="text-center">
        ...
        <button
          ...
          class="mt-6 rounded-xl bg-cyan-500 px-6 py-3 text-white font-bold hover:bg-cyan-600 transition"
        >
          Tentar novamente
        </button>
      </div>
          ...
          <div class="px-8 py-6">
            ...
            <div class="mt-6 flex items-center gap-3">
              ...
              <button
                ...
                class="flex flex-1 items-center justify-center gap-2 rounded-xl bg-cyan-600 px-6 py-3 text-white font-bold text-base hover:bg-cyan-700 active:scale-95 transition-all shadow-lg shadow-cyan-900/30"
              >
    ...
    <Transition name="fade">
      <button
        v-if="mostrarTopo"
        @click="scrollTopo"
        class="fixed bottom-6 right-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-cyan-500 text-white shadow-xl hover:bg-cyan-600 active:scale-90 transition-all"
      >
        <ChevronUp :size="22" />
      </button>
    </Transition>
